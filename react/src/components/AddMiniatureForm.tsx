                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                className="flex-1 px-3 py-2 bg-terminal-bg border-l-4 border-terminal-border text-terminal-fg focus:outline-none focus:border-terminal-accent focus:shadow-terminal transition-all font-mono uppercase"
                            >
